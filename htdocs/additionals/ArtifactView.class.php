...
public function showArtifacts()
{
  ...
  {
    echo "<tr>";
    echo "<td align='center' style='border:1px solid blue; font-size:18; font-weight:bold'>" . $artifact['name'] . "</td>";
    echo "<td align='center'style='border:1px solid blue; font-size:18; font-weight:bold'>" . $artifact['group_number'] . "</td>";
    echo "<td align='center'style='border:1px solid blue; font-size:18; font-weight:bold'>" . '<a target=\"_blank\" href='.$artifact["link"] . '>View Artifact</a>' . "</td>";
    echo "</tr>";
  }
echo "</table>";
}
