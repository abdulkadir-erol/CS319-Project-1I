...
protected function insertChangeRequest($stuID, $state, $targetGroup)
{
  ...
  protected function closeArtifactTable(){
  ...
  protected function closeArtifactCommentTable(){
    $sql = "SELECT * FROM artifact_comment";
    $stmt = $this->connect()->prepare($sql);
    $stmt->execute([]);
    $artifactcomments = $stmt->fetchAll();
    foreach($artifactcomments as $artifactcomment)
    {
      $artifactcommentID = $artifactcomment["id"];
      $sql = "DELETE FROM artifact_comment WHERE id = '$artifactcommentID'";
      $stmt = $this->connect()->prepare($sql);
      $stmt->execute();
    }
  }
  protected function closeCourseTable(){
  ...
  protected function closeGroupTable(){
    ...
    {
      $groupID = $group["id"];
      $sql = "DELETE FROM grup WHERE id = '$groupID'";
      $stmt = $this->connect()->prepare($sql);
      $stmt->execute();
    }
  }

  protected function closeSectionTable(){
  ...
  protected function closeStudentTable(){
  ...
  {
    $this->closeArtifactTable();
    $this->closeArtifactCommentTable();
    $this->closeCourseTable();
    $this->closeGroupTable();
    $this->closeStudentTable();  
  }
/*
  protected function closeCourse()
  {
